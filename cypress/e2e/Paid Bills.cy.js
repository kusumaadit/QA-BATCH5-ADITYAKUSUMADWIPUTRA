describe('Paid Test', () => {
    it('Paid', () => {
      ...
      cy.get('input[id="Input_SearchKeyword').type("TestInvoice3")

      cy.contains('td[data-header="Invoice"] a', 'TestInvoice3').click();
      ...
      cy.get("input[id='Input_CVV']").type("732")
    
      cy.get("button[class='btn btn-primary']").click("")
      
      cy.wait(2000)

      cy.get("span.padding-left-xs").click("")
