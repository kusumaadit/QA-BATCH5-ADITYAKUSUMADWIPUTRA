describe('Create New Request', () => {
    ...
    it('New Request', () => {
      ...
      cy.get('input[id="Input_InvoiceNumber"]').type("TestInvoice2")

      cy.get('input[id="Input_PeriodStartDate"]').type("2024-03-02T20:12")

      cy.get('input[id="Input_PeriodEndDate"]').type("2024-04-04T20:12")

      cy.get('input[id="Input_Amount"]').type('3000')
